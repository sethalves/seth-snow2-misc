(repository
  ...
  (package
    ...
    (url "ieee-754.tgz")
    (size 9728)
    (checksum (md5 "baaa8d472533d7296b55d3b060311614"))
    (library
      (name (seth ieee-754))
      (path "seth/ieee-754.sld")
      (version "1.0")
      (homepage "https://github.com/sethalves")
      (manual)
      (maintainers "Seth Alves <seth@hungry.com>")
      (authors "Seth Alves <seth@hungry.com>")
      (description "convert to or from ieee-754 floating-point format")
      (license BSD-style)
      (depends (snow assert) (srfi 60))
      (use-for final))
    (library
      (name (seth ieee-754 tests))
      (path "seth/ieee-754/tests.sld")
      (version "1.0")
      (homepage "https://github.com/sethalves")
      (manual)
      (maintainers "Seth Alves <seth@hungry.com>")
      (authors "Seth Alves <seth@hungry.com>")
      (description "tests for (seth ieee-754)")
      (license BSD-style)
      (depends (seth ieee-754))
      (use-for test)))
  (package
    (name (octree))
    (version "1.0")
  ...
  (package
    ...
    (url "scad-model.tgz")
    (size 16896)
    (checksum (md5 "9c1fbe03214975b4355f3f4dfdf453fd"))
    (library
  ...
  (package
    ...
    (url "flex.tgz")
    (size 17408)
    (checksum (md5 "fec47a20e28faf11c1090a80f384ff58"))
    (library
      (name (seth flex))
      (path "seth/flex.sld")
      (version "1.0")
